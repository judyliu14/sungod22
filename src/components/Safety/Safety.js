...
const data = {
  rows: [
    ...
    {
      title: 'MAP (Medical Amnesty Program)',
      content: `<b>This protocol protects students who receive (or initiate) medical assistance in an alcohol or controlled substance-related medical emergency. If all of the following apply, students WILL NOT be subject to the formal student conduct process. For more info, visit <a href="https://students.ucsd.edu/_files/student-conduct/Medical%20Amnesty%20Program%20UPDATED%203-2-21.pdf" style="color:#b68e89; alt="RAP">MAP (Medical Amnesty Program)</a></b> <ul> <li>Someone contacts a House Advisor/Resident Advisor or other University Official for medical assistance on behalf of a student experiencing an alcohol or controlled substance-related medical emergency (or if the student makes the request) </li> <li>No other major Student Conduct Code violations (including, but not limited to, disorderly conduct, distribution of controlled substances, hazing, physical assault, vandalism, etc.) were committed by the student during the same incident. </li> <li>The student has not received protection under this Protocol more than once in a two calendar year period</li> </ul>`
    },
    {
      title: 'A.S. Safe Rides',
      content: `Having a transportation plan is important for your health & safety at the festival. Check out our 
                <a href="/transportation">
                  Transportation Page 
                </a> 
                to learn more about 
                <a href="https://finance.ucsd.edu/SafeRides/Home" style="color:#b68e89; alt="AS Safe Rides"> 
                  AS Safe Rides 
                </a> 
                and how you and your friends can safely get to and from the festival.
                <ul>
                  <li>Please follow the AS Safe Ride page to register with your Lyft business profile in order to use our codes!</li>
                  <li>We are providing <b>TOSG2022</b> for going from your location to Sun God transportation.</li>
                  <li>And <b>FROMSG2022</b> for going back from Sun God to your desired transportation location.</li>
                  <li>Each code will contain a 2000 redeeming limit and it will take $10 off your ride!</li>
                  <li>Quantity limited, first come first serve.</li>
                </ul>`
    },
    {
      title: "On The Field",
      content: `<ul> 
                  <li>Festival safety staff will wear clearly identifiable uniforms.</li>
                  <li>First Aid stations will be available throughout the venue. </li>
                  <li>There will be free water at two fill-up locations for any attendee with a reusable, non-glass bottle. </li> <li>There will be a Lost & Found and Information booth located near the entrance to the field. After the festival, found items will be relocated to the <a href="http://blink.ucsd.edu/safety/emergencies/security/contacts.html" style="color:#b68e89; alt="UCSD Police Department">UCSD Police Department</a></li> <li>All of the above stations will be clearly marked on the festival map and visible on the field.</li> 
                </ul>`
    },
    {
      title: "Important Contacts",
      content: '<ul> <li>For Help: Call (858) 534-HELP or ask for help from the nearest security guard or staff member. Learn about and use the Medical Amnesty Program (MAP), which may keep you from getting in trouble.</li> <li>Detox: If your friend is taken to Sun God Festival Detox, you can call (858)246-0393. It takes about 20 minutes for a student to be checked-in, so there may not be a record of them yet if you call right after they are picked up. If your friend is checked in, the volunteer will let you know the estimated time to call back (approx. 4 hours) and where to pick them up.</li> <li>ADA Guest Services: Call (858) 864-8242 to reach a liaison who will happily assist with providing a seamless Sun God Festival experience.</li> </ul>'
    },
    {
      title: "Health & Wellness",
      content: `<ul> 
                  <li><b>Sleep</b>: Sleep impacts your physical health and your cognitive functioning. Be sure to get plenty of sleep prior to the event. Be aware that alcohol and caffeine can have a negative impact on your sleep. </li> 
                  <li><b>Exercise</b>: Regular exercise and physical activity help to improve your mood and cope with stress and anxiety.</li> <li><b>Eating</b>: Eating right is an important part of stress management, helps you maintain energy throughout the day, improves cognitive performance, and keeps your mood steady.</li> 
                  <li><b>Time Management</b>: Prepare in advance for the amount of time you’ll need to study for midterm exams. When you know you have a large event coming up that will take a lot of time (e.g., attending a wedding, a birthday party, SUN GOD!), it’s important to plan effectively. Start weeks in advance and schedule study time around this large event. This way you can actually enjoy the event while you are there! It will also reduce the likelihood of you having to cram and pull an “all-nighter.</li> <li><b>Social support</b>: Relationships are one of the most important factors of well-being. Developing, deepening, and maintaining close, supportive relationships help us to flourish. While at UCSD, it’s important to not just focus on academics, but to find a sense of belonging and community; to be part of a group in which you feel you are a valued member. Close relationships help to reduce loneliness and provide support during stressful times.</li> 
                  <li><b>Find your passion</b>: Find at least one interest or hobby that you can pursue and look forward to once or twice a week. “Engagement” in activities in which you get completely absorbed and feel perfectly challenged, neither bored nor overwhelmed, can be extremely rewarding and help us to flourish.</li> 
                  <li>For more information about Tritons Flourish, please visit <a href="https://caps.ucsd.edu/flourish" alt="CAPS"> CAPS Flourish</a>.</li> 
                  <li>For more information about Counseling and Psychological services available on campus, please visit <a href="https://caps.ucsd.edu" alt="CAPS"> CAPS</a>.</li> </ul>`
    }
  ]
}
